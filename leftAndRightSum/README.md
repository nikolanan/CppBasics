A program that reads 2 * n-th number of integers entered by the user and checks whether the sum of the first n numbers (left sum) is equal to the sum of the second n numbers (right sum).
